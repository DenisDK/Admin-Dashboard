      ...
      <div className={style.item}>
        ...
        <div className={style.text}>
          ...
          <p className={style.desc}>
            ...
            perferendis aliquam facere quam ipsa qui, sequi, rem repellendus
            harum eius amet voluptatum explicabo assumenda, consequuntur aut
            nisi. Exercitationem, eos atque?
          </p>
